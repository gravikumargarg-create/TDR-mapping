"""Production data – LVT TDR Delivery (report + INSERT SQL, no DB)."""
import os
import sys
import tempfile
...
# Back to Portal (markdown links avoid KeyError on Streamlit Cloud)
    ...
    if not lvt_file or lvt_file.size == 0:
        ...
        try:
            ...
            with st.spinner("Processing…"):
                report_path, _sql_synth, sql_path, _ = run_lvt_tdr_from_paths(
